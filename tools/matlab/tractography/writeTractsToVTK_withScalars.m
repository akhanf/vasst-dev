...
for i=1:size(in_scalars_cell,1)
    
    
datatype_matlab=class(in_scalars_cell{i,1});
datatype_vtk=in_scalars_cell{i,3};
dataname=in_scalars_cell{i,2};


fprintf(fid,'SCALARS %s %s 1\n',dataname,datatype_vtk);
fprintf(fid,'LOOKUP_TABLE default\n');

fwrite(fid,in_scalars_cell{i,1},datatype_matlab,0,'b');
fprintf(fid,'\n');
